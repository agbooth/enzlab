...
#ifndef EnzLab_el_Limits_h
#define EnzLab_el_Limits_h
...
#define V_CLEAR             -20.0   // signal to clear the view
...
#define GRAPH_BOTTOMCHARS	5		// number of chars space at bottom of graph (including labels/tics)
