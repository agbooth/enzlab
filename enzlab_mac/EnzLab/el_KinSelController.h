...
@interface el_KinSelController : NSViewController <NSTableViewDataSource,NSTableViewDelegate>
...
@property (strong) IBOutlet NSNumberFormatter *formatter;
